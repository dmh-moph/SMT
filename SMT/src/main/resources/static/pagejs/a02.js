...
var SearchView = Backbone.View.extend({
    initialize: function(options){
    	...
    	this.searchModel = new smt.Model.fileHistoryRecordSearch();
...
var TableResultView = Backbone.View.extend({ 
	initialize: function(options){
		this.searchResults = new smt.Collection.fileHistoryRecordSearches();
	...
	render: function() {
		if(this.searchModel != null) {
			...
			this.searchResults.fetch({
				url: appUrl('FileHistoryRecord/stat/JOURNAL/findHistoryCountBetween'),
	    		type: 'POST',
	    		data: {
	    			start: this.searchModel.get('start'),
	    			end: this.searchModel.get('end')
	    		},
